...
| **Filter Lists** | **Links** | **Information** |
|:-----------------|:----------|:----------------|
| **[Accelerated Mobile Page Removal][Accelerated Mobile Page Removal Filter]** | **Raw:** <br> [Click Here][Accelerated Mobile Page Removal Raw] <br><br> **Subscribe:** <br> [Click Here][Accelerated Mobile Page Removal Subscription] | **Description:** <br> This filter list is for removing [Accelerated Mobile Pages][Accelerated Mobile Pages Home Page Link] on iOS. <br><br> **Disclaimer:** <br> If using this filter list on iOS, it will require the use of "Advanced Protection" in AdGuard Premium/Pro and will also require at least iOS 15.4. To learn more about Accelerated Mobile Pages, click on this [link][Accelerated Mobile Pages Wikipedia Link]. <br><br> **Issues:** <br> If you encounter an Accelerated Mobile Page while using this filter list on Safari for iOS, please create an issue that includes the website's URL. Also, if this filter list causes an Accelerated Mobile Page to reload in an infinite loop, please create an issue that includes the website's URL.
| **[Smart App Banner Removal][Smart App Banner Removal Filter]** | **Raw:** <br> [Click Here][Smart App Banner Removal Raw] <br><br> **Subscribe:** <br> [Click Here][Smart App Banner Removal Subscription] | **Description:** <br> This filter list is for removing [Smart App Banners][Smart App Banners Apple View Link] on iOS. <br><br> **Disclaimer:** <br> When using this filter list on iOS, please make sure to enable "Advanced Protection" in AdGuard Premium/Pro. Regarding the filters themselves, they cannot remove any [Smart App Banner][Smart App Banners Apple Open Link] that shows up when the application is already downloaded and installed on your Apple device. To learn more about Smart App Banners on iOS, click on this [link][Smart App Banners Apple Link]. <br><br> **Issues:** <br> If a Smart App Banner appears when you are browsing on Safari for iOS, please refresh the page once or twice. If the banner does not disappear on that web page after you have refreshed the page, please create an issue that includes the website's URL.
